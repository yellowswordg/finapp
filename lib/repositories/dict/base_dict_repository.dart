...
class BaseDictRepository extends BaseRepository {
  static const String DB_NAME = 'dict.db';

  // Singleton patern db implementation
  //we'll only have one instance of db
  static final BaseDictRepository _instance = BaseDictRepository._();
  static Database _database;
  BaseDictRepository._();

  factory BaseDictRepository() {
    return _instance;
  }
